...
class AndroidBuilder(object):
    ...
    def __init__(self, verbose, app_android_root, no_res, proj_obj, mode, build_type, app_abi, gradle_support_ndk=False):
        ...
        self.proj_sign_prop_file = os.path.join(self.app_android_root, "gradle.properties")
    ...
    def _parse_cfg(self):
        ...
        raise cocos.CCPluginError('only support Gradle, no read %s anymore !!!' % os.path.join(self.app_android_root, BUILD_CFIG_FILE))
    ...
    def has_keystore_in_signprops(self):
        ...
        try:
            for path in [self.sign_prop_file, self.proj_sign_prop_file]:
    ...
    def _write_local_properties(self, folder_path):
        ...
        # if os.path.exists(local_porps_path):
        #     return
