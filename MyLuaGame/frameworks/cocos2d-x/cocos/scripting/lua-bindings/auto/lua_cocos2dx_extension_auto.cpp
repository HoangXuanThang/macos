...
int lua_cocos2dx_extension_AssetsManagerEx_onLuaError(lua_State* tolua_S)
{
	int argc = 0;
	cocos2d::extension::AssetsManagerEx* cobj = nullptr;
	bool ok = true;
	...
	if (!cobj)
	{
		tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_extension_AssetsManagerEx_onLuaError'", nullptr);
		return 0;
	}
#endif
	...
	if (argc == 0)
	{
		if (!ok)
		{
			tolua_error(tolua_S, "invalid arguments in function 'lua_cocos2dx_extension_AssetsManagerEx_onLuaError'", nullptr);
			return 0;
		}
		cobj->onLuaError();
		lua_settop(tolua_S, 1);
	...
	luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.AssetsManagerEx:onLuaError", argc, 0);
	return 0;

#if COCOS2D_DEBUG >= 1
	tolua_lerror:
				tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_extension_AssetsManagerEx_onLuaError'.", &tolua_err);
#endif
...
int lua_register_cocos2dx_extension_AssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"AssetsManagerEx");
		...
		tolua_function(tolua_S, "onLuaError", lua_cocos2dx_extension_AssetsManagerEx_onLuaError);
