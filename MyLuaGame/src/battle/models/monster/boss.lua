...
local hpToAction = {
	...
	[bossLifeStage.minor] = {changeAction = nil, changeActionFrame = nil, standbyAction = "standby_loop", hitAction = "hit"},
	[bossLifeStage.serious] ={changeAction = nil, changeActionFrame = nil, standbyAction = "standby_loop", hitAction = "hit"},
...
function BossModel:init(data)
	...
	if self.huodongCsv then
		...
		self.view:notify('pushAction', battle.SpriteActionTable.death, "hit")
	end
end
