...
function BattleEndWinView:updateAwardInfo(receiveTime)
    ...
    if self.isFirstAward then
       -- backBtn:visible(false)
		...
		uiEasy.setBtnShader(backBtn, backBtn:get("text"), 2)
		text.deleteAllEffect(backBtn:get("text"))
		...
		if receiveTime == 0 then
			...
			uiEasy.setBtnShader(backBtn, backBtn:get("text"), 1)
			backBtn:setEnabled(true)
			text.addEffect(backBtn:get("text"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW}})
