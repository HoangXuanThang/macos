...
function Stage:onSkillPreAni( hideHero)
	local hide = function()
...
function Stage:onUltSkillPreAni2(id, skillCfg, hideHero)
	...
	local hero = newCSprite("config/big_hero/skill/"..skillCfg.effectBigName[1]..".png")
	local heroBg = newCSprite("config/big_hero/skill/"..skillCfg.effectBigName[1]..".png")
	...
	if isCombineSkill then
		...
		combHero = newCSprite("config/big_hero/skill/"..skillCfg.effectBigName[2]..".png")
		combHeroBg = newCSprite("config/big_hero/skill/"..skillCfg.effectBigName[2]..".png")
	end
	...
	hero:scale(heroNodeScaleX*1.1, 1.1)
	heroBg:scale(heroNodeScaleX*1.15, 1.15)
