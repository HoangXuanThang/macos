	...
	elseif showType == "txt" then
		...
		if self.isGray then
			text.addEffect(titleTxt,
				{ outline = { color = cc.c4b(99, 97, 97, 255), size = 4 }, color = cc.c4b(235, 235, 235, 255) })
		else
			text.addEffect(titleTxt,
				{ outline = { color = cc.c4b(cfg.color[1], cfg.color[2], cfg.color[3], 255), size = 4 } })
		end
	elseif showType == "spine" then
		local spine = widget.addAnimationByKey(panel, cfg.res, "spine", "default", 1, true)
