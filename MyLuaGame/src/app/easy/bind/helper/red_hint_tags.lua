...
local tagModelHelpers = {
	...
	monopolyWalk = bindHelper.model("role", "monopoly"),
	zfrags = bindHelper.model("role", "zfrags"),
	draw_sum_box = bindHelper.model("role", "draw_sum_box"),
	-- crossSupremacyRemind = bindHelper.model("role", "cross_supremacy_remind"),
	-- crossSupremacyRound = bindHelper.model("role", "cross_supremacy_round"),

	starAid = bindHelper.model("role", "card_star_swap_fields"),
	starExchange = bindHelper.model("role", "card_star_swap_times"),
	...
	weeklyCardFRClick = bindHelper.model("currday_dispatch", "weeklyCardFR"),
	supremeCardClick = bindHelper.model("currday_dispatch", "supremeCard"),
	...
	themeSkinGiftClick = bindHelper.model("currday_dispatch", "themeSkinGiftClick"),
	themeSkinGiveClick = bindHelper.model("currday_dispatch", "themeSkinGiveClick"),
	themeSkinExchangeClick = bindHelper.model("currday_dispatch", "themeSkinExchangeClick"),
	christmasClick = bindHelper.model("currday_dispatch", "christmasClick"),
	redHintDailyClick = bindHelper.model("currday_dispatch", "redHintDaily"),

	miixGiftClick = bindHelper.model("currday_dispatch", "miixGiftClick"),

	starAidDailyClick = bindHelper.model("currday_dispatch", "starAidDailyClick"),
	starExchangeDailyClick = bindHelper.model("currday_dispatch", "starExchangeDailyClick"),
	card_star_swap_times_deliver_record = bindHelper.model("role", "card_star_swap_times_deliver_record"),
	...
	jiuWeiGiftClick = bindHelper.model("currday_dispatch", "jiuWeiGiftClick"),
	jiuWeiExchangeClick = bindHelper.model("currday_dispatch", "jiuWeiExchangeClick"),
	...
	zhutiYingxiongShopClick = bindHelper.model("currday_dispatch", "zhutiYingxiongShopClick"),
}
...
redHintHelperTags.activitySessionGift = {
	yyHuodongs = true,
	yyOpen = true,
}
...
redHintHelperTags.activityMiixBuyGift = {
	yyHuodongs = true,
	miixGiftClick = true,
	yyOpen = true,
}

redHintHelperTags.activityWeeklyCardFR = {
	yyHuodongs = true,
	weeklyCardFRClick = true,
	yyOpen = true,
}

redHintHelperTags.supremeCard = {
	yyHuodongs = true,
	supremeCardClick = true,
	yyOpen = true,
}
...
-- redHintHelperTags.crossSupremacyAward = {
-- 	crossSupremacyRemind = true,
-- 	crossSupremacyRound = true
-- }

redHintHelperTags.limitUpgradeSprite = {
	yyOpen = true,
	yyHuodongs = true,
	cards = true,
}

redHintHelperTags.customizeUpgradeSprite = {
	yyOpen = true,
	yyHuodongs = true,
	cards = true,
}

redHintHelperTags.starSwapAid = {
	starAid = true,
	starAidDailyClick = true
}

redHintHelperTags.starSwapExchange = {
	starExchange = true,
	starExchangeDailyClick = true
}

redHintHelperTags.starSwapReceiveCount = {
	card_star_swap_times_deliver_record = true
}

redHintHelperTags.activityThemeSkinSignIn = {
	yyHuodongs = true,
	yyOpen = true,
}

redHintHelperTags.activityThemeSkinGift = {
	yyHuodongs = true,
	yyOpen = true,
	themeSkinGiftClick = true,
}

redHintHelperTags.activityThemeSkinGive = {
	yyHuodongs = true,
	yyOpen = true,
	themeSkinGiveClick = true,
}

redHintHelperTags.activityThemeSkinExchange = {
	yyHuodongs = true,
	yyOpen = true,
	-- items = true,
	themeSkinExchangeClick = true,
}

-- 活动抽奖箱子奖励
redHintHelperTags.activityDrawBoxAward = {
	yyOpen = true,
	yyHuodongs = true,
	draw_sum_box = true,
}

redHintHelperTags.activityChristmasWishGift = {
	yyHuodongs = true,
	yyOpen = true,
	christmasClick = true,
}

redHintHelperTags.activityChristmasWish = {
	yyHuodongs = true,
	yyOpen = true,
	items = true,
}

redHintHelperTags.activityZhutiYingxiongShop = {
	yyHuodongs = true,
	yyOpen = true,
	zhutiYingxiongShopClick = true,
}

redHintHelperTags.playPassportZhutiYingxiong = {
	yyOpen = true,
	yyHuodongs = true,
}

redHintHelperTags.activityZhutiYingxiongSignIn = {
	yyHuodongs = true,
	yyOpen = true,
}

redHintHelperTags.activitySignIn = {
	yyHuodongs = true,
	yyOpen = true,
}

redHintHelperTags.activityDarwDayGift = {
	yyHuodongs = true,
	yyOpen = true,
}

redHintHelperTags.redHintDaily = {
	redHintDailyClick = true,
}

redHintHelperTags.activityJiuWeiSignIn = {
	yyHuodongs = true,
	yyOpen = true,
}

redHintHelperTags.activityJiuWeiGift = {
	yyHuodongs = true,
	yyOpen = true,
	jiuWeiGiftClick = true,
}

redHintHelperTags.activityJiuWeiExchange = {
	yyHuodongs = true,
	yyOpen = true,
	jiuWeiExchangeClick = true,
}

redHintHelperTags.playPassportJiuWei = {
	yyOpen = true,
	yyHuodongs = true,
}

redHintHelperTags.monopolyWalkTask = {
	monopolyWalk = true,
	yyHuodongs = true,
}

redHintHelperTags.monopolyWalkBoxAward = {
	monopolyWalk = true,
	yyHuodongs = true,
}

-- 登天之阶
redHintHelperTags.activityThrone = {
	yyOpen = true,
	yyHuodongs = true,
	redHintDailyClick = true,
}

redHintHelperTags.activityThroneSignIn = {
	yyHuodongs = true,
	yyOpen = true,
}

redHintHelperTags.playPassportThrone = {
	yyOpen = true,
	yyHuodongs = true,
}

redHintHelperTags.activityDrawLimitExplor = {
	yyOpen = true,
	yyHuodongs = true,
	redHintDailyClick = true,
}

redHintHelperTags.activityDrawLimitHelditem = {
	yyOpen = true,
	yyHuodongs = true,
	redHintDailyClick = true,
}
