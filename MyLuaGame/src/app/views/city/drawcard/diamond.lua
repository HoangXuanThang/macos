...
function t.initPageItemFunc(self, curType, goldCount, diamondCount, allCount, half, trainerCount, equipCount,
							drawEquipCount)
	...
	text.addEffect(self.txtFree, { color = cc.c4b(60, 237, 60, 255) })
	...
	if half == 0 and not isFree and addVal ~= 0 then
		...
		adapt.oneLinePos(childs.textNote, { childs.textCost, childs.textDiscount, childs.imgIcon },
			{ cc.p(0, 0), cc.p(5, 0), cc.p(0, 0) })
	...
	widget.addAnimationByKey(self.diamondPanel:getChildByName("spinePanel1"), "lihui/lihui_yuanbanlin.skel",
		"spinePanel1", "default", 1, true):scale(0.9)
	widget.addAnimationByKey(self.diamondPanel:getChildByName("spinePanel2"), "lihui/lihui_xiaomeiyan.skel",
		"spinePanel2", "default", 1, true):scale(0.8):y(100)
	widget.addAnimationByKey(self.diamondPanel:getChildByName("spinePanel3"), "lihui/lihui_xiaoyuan.skel",
		"spinePanel3", "default", 1, true)
end
