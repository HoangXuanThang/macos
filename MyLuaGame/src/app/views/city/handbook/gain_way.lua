			...
			props = {
				...
				onItem = function(list, node, k, v)
					if not v.text1 then
						...
						text.addEffect(btnText, {color = color,outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
						...
						text.addEffect(node:get("btnJump"):get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
						adapt.oneLinePos(node:get("textNote1"), node:get("textInfo"), cc.p(15, 0), "left")
