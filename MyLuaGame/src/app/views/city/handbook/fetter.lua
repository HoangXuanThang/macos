...
local function setItemToList(list, node, item, id, open)
	...
	local color = open and ui.COLORS.NORMAL.WHITE or ui.NEWCOLORS.GRAY2
		...
		binds = {
			...
			props = {
				...
				onItem = function(list, node, k, data)
					...
					local path1 = "city/handbook/box_output1.png"
					local path2 = "city/handbook/tag__jb_01.png"
					local outLineColor = cc.c4b(166, 151, 149, 255)
					if canUsed then
						path1 = "city/handbook/box_output.png"
						path2 = "city/handbook/tag__jb_00.png"
					...
					for i,v in csvPairs(fetter.attrMap) do
						...
						local str = string.format("#C0xFFFFFF#%s"..gLanguageCsv.improve.." %s",name, dataEasy.getAttrValueString(i, v))--EF3453
