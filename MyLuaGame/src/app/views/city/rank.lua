...
local function itemShow(list, node, k, v, index)
	local childs = node:multiget("img", "num", "name", "iconBg", "level", "bg","szbg2")
...
RankView.RESOURCE_BINDING = {
	...
	["rightPanel.topPanelbiaoti_bg.biaoti_bg"] = "rightTopBg",
}
...
function RankView:adapUI()
	...
	local adaptPos1 =  self.itemCraft:multiget("img", "num", "iconBg", "name", "txt", "level","szbg1","szbg2")
	...
	local itemFightPos1 =  self.itemFight:multiget("img", "num", "iconBg", "name", "txt", "level","szbg1","szbg2")
	...
	local bottomFightAdapt3 = self.bottomPanelFight:multiget("bg")



	local itemUnionWidth = self.itemUnion:multiget("bg")
	local itemUnionPos1 =  self.itemUnion:multiget("img", "num", "txt", "level", "iconBg", "name", "icon","szbg1","szbg2")
	...
	local unionbg1 =  self.itemUnion:multiget("union_bg")
	local unionbg2 =  self.itemUnion:multiget("union_szbg")

	local itemCollectWidth = self.itemCollect:multiget("bg")
	local itemCollectPos1 =  self.itemCollect:multiget("img", "num", "iconBg", "name", "txt", "level","szbg1","szbg2")
	...
	local collectbg1 =  self.itemCollect:multiget("collect_bg")
	local collectbg2 =  self.itemCollect:multiget("collect_szbg")

	local itemGateStarWidth =  self.itemGateStar:multiget("bg")
	local itemGateStarPos1 =  self.itemGateStar:multiget("img", "num", "iconBg", "name", "txt", "level","szbg1","szbg2")
	...
	local gatestarbg1 =  self.itemGateStar:multiget("gatestar_bg")
	local gatestarbg2 =  self.itemGateStar:multiget("gatestar_szbg")
	...
	adapt.centerWithScreen("left", "right", nil, {
		...
		{self.rightTopBg, "width"},
		{self.rightTopBg, "pos", "right"},
