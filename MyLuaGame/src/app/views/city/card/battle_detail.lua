...
function CardBattleDetailView:setRightPanel(battleData)
	...
	local richTxt1 = createRichTxt("#C0x57472E#" .. battleCsv.features, 40, -15, childs.titleBg1, 1160)
	local richTxt2 = createRichTxt("#C0x57472E#" .. battleCsv.coreEffect, 40, -15, childs.titleBg2, 1160)
	...
	for i=1,10 do
		if battleCsv["matchEffect"..i] and battleCsv["matchEffect"..i] ~= "" then
			table.insert(strs, {
				str = "#C0x57472E#" .. battleCsv["matchEffect"..i],
				verticalSpace = 10
			})
		end
	end
