...
local ITEM_SIZES_POS = {
	[1] = {pos = cc.p(0, 0), size = cc.size(450, 250)},
	[2] = {pos = cc.p(0, 0), size = cc.size(500, 250)},
	[3] = {pos = cc.p(0, 0), size = cc.size(500, 250)},
	[4] = {pos = cc.p(0, 0), size = cc.size(450, 250)},
	[5] = {pos = cc.p(0, 0), size = cc.size(500, 250)},
	[6] = {pos = cc.p(0, 0), size = cc.size(500, 250)},
}
...
function CardEmbattleView:whichEmbattleTargetPos(p)
	...
	for i = self.panelNum, 1, -1 do
		...
		if box and cc.rectContainsPoint(box, p) then
			return i
		end
	end
	return nil
