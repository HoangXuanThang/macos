...
BattlsManualsView.RESOURCE_BINDING = {
	...
	["name"] = {
		binds = {
			{
				event = "effect",
				data = {outline = {color = ui.NEWCOLORS.OUTLINE.RED, size = 4}}
			},
		},
	},
	["right.title.name"] = {
		...
		binds = {
			{
				event = "effect",
				data = {outline = {color = ui.NEWCOLORS.OUTLINE.BROWN2, size = 4}}
			},
		},
	},
	["item"] = "item",
...
function BattlsManualsView:rightUpdata(k)
	...
	if height > list:size().height then
		...
		self.rightList:setScrollBarColor(cc.c3b(245,156,2))
