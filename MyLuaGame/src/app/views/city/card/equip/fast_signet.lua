...
function CardSignetOneKeyView:onCreate(selectDbId, equipId, cb)
	...
	text.addEffect(self.cardName, {color= quality == 1 and ui.COLORS.NORMAL.WHITE or ui.COLORS.QUALITY[quality]})
	...
	idlereasy.when(self.selectLv, function(_, selectLv)
		...
		if self.upgradeLv <= maxLv then
			...
			local coinColor = self.isEnoughGoldStrengthen and ui.COLORS.NORMAL.WHITE or ui.COLORS.NORMAL.RED
