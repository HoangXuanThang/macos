		...
		binds = {
			...
			props = {
				...
				onItem = function(list, node, k, v)
					...
					local color = v.select and ui.COLORS.WHITE or ui.COLORS.WHITE
...
function GemView:onCreate(curCardId)
	...
	for k, v in ipairs({'btnDraw', 'btnShowAll', 'btnPoint', 'btnDecompose'}) do
		text.addEffect(self.left:get(v):get('txt'), {outline = {color=ui.NEWCOLORS.OUTLINE.BLACK, size=4}})
	end
