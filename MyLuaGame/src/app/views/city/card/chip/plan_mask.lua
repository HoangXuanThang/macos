...
function ChipPlanMaskView:onCreate(params)
	...
	text.addEffect(self.panel:get("tip1"), { outline = { color = ui.NEWCOLORS.OUTLINE.BLACK, size = 8 } })
	text.addEffect(self.panel:get("tip2"), { outline = { color = ui.NEWCOLORS.OUTLINE.BLACK, size = 8 } })
