	...
	for index, cfg in ipairs(csv.chip.suits) do
		...
		if not suitDatas[cfg.suitID] then
			...
			for val, cfg in pairs(cfgData) do
				...
				str = string.gsub(str, "#C0xF3895B#", "#C0xEB580E#")
				if cfg.skillID and cfg.skillID ~= 0 then
					str = str.."#C0x57472E#"..string.gsub(csv.skill[cfg.skillID].describe, "#C0x5B545B#", "#C0x57472E#")
					...
					for index = 1, math.huge do
						...
						if attrT and attrT ~= 0 then
							...
							str = string.gsub(str, "#C0x3CFF3C#", "#C0x01A001#")
							str = string.gsub(str, "#C0xFFFCED#", "#C0x57472E#")
						end
