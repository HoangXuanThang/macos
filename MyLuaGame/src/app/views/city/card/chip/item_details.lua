...
function ChipItemDetailsView:onCreate(params)
	...
	idlereasy.when(self.num, function(_, num)
		...
		text.addEffect(self.panel:get("gainExp"),
			{ color = num > 0 and cc.c4b(96, 196, 86, 255) or cc.c4b(183, 176, 158, 255) })
...
function ChipItemDetailsView:onOKClick()
	...
	local nextLevelExp = csv.chip.strength_cost[self.clientChipLevel:read()]["levelExp" .. self.chipCfg.strengthSeq] -
	self.clientChipLevelExp:read()
