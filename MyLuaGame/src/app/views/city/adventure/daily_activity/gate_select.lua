			...
			props = {
				...
				onItem = function(list, node, k, v)
					...
					if v.limitGate then
						...
						text.addEffect(childs.btnChallenge:get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
						text.addEffect(childs.btnJxNext:get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
						text.addEffect(childs.btnJxWipe:get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
