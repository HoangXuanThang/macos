...
function RandomTowerGateDetail:onCreate(boardId, fightCb, passCb)
	...
	local title1 = string.utf8limit(boardCfg["name_"..LOCAL_LANGUAGE] or boardCfg.name, 2, true)
	local title2 = string.sub(boardCfg["name_"..LOCAL_LANGUAGE] or boardCfg.name, #title1 + 1)
