				...
				onItem = function(list, node, k, v)
					...
					if LOG_LANGUGE[v.type] == "gymClosed" then
						...
						if v.leader_gym_id then
							...
							str = str .."\n" .. string.format(gLanguageCsv.gymGarrison1, color..name.."#C0xFFFFFF#", "#T44-0.8#")
						end
						if v.cross_leader_gym_id then
							...
							str = str .."\n"..string.format(gLanguageCsv.gymGarrison1, color..gLanguageCsv.crossServer..name.."#C0xFFFFFF#", "#T45-0.8#")
						end
						if v.cross_gym_id then
							local name = csv.gym.gym[v.cross_gym_id].name
							local color = csv.gym.gym[v.cross_gym_id].fontColor
							str = str .."\n"..string.format(gLanguageCsv.gymGarrison2, color..gLanguageCsv.crossServer..name.."#C0xFFFFFF#", "#T45-0.8#")
						end
					elseif v.gym_id then
						...
						if string.find(LOG_LANGUGE[v.type], "cross") then
							str = string.format(gLanguageCsv[LOG_LANGUGE[v.type]], color..gLanguageCsv.crossServer..name.."#C0xFFFFFF#")
						else
							str = string.format(gLanguageCsv[LOG_LANGUGE[v.type]], color..name.."#C0xFFFFFF#")
						end
						str = string.format(str, color..name.."#C0xFFFFFF#")
