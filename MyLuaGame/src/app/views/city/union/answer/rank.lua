...
function UnionAnswerRankView:onCreate(tb)
	...
	idlereasy.when(self.rankType, function (_, rankType)
		...
		text.addEffect(self.btn1:get("txt"), {outline = {color = rankType == 1 and ui.NEWCOLORS.OUTLINE.YELLOW or ui.NEWCOLORS.OUTLINE.BLUE, size = 4}})
		text.addEffect(self.btn2:get("txt"), {outline = {color = rankType == 2 and ui.NEWCOLORS.OUTLINE.YELLOW or ui.NEWCOLORS.OUTLINE.BLUE, size = 4}})
		text.addEffect(self.btn3:get("txt"), {outline = {color = rankType == 3 and ui.NEWCOLORS.OUTLINE.YELLOW or ui.NEWCOLORS.OUTLINE.BLUE, size = 4}})
