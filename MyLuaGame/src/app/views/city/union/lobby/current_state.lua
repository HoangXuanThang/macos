...
function UnionCurrentStateView:onCreate()
	...
	self.textInput:setPlaceHolderColor(ui.NEWCOLORS.GRAY3)
	self.textInput:setTextColor(ui.NEWCOLORS.BROWN2)
	...
	idlereasy.any({self.limitNum, self.selectJoinType},function(_,limitNum, selectJoinType)
		...
		local coinColor = (limitNum == 0) and ui.NEWCOLORS.WHITE2 or ui.NEWCOLORS.WHITE2
