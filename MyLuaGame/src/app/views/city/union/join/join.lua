		...
		binds = {
			...
			props = {
				...
				onItem = function(list, node, k, v)
					...
					text.addEffect(children.btnRight:get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
...
function UnionJoinView:onCreate(listDatas)
	...
	self.textInput:setPlaceHolderColor(ui.NEWCOLORS.BROWN1)
