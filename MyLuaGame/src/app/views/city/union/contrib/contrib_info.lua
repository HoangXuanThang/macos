		...
		binds = {
			...
			props = {
				...
				onItem = function(list, node, k, v)
					...
					local color = ui.NEWCOLORS.BROWN1
					...
					if v.canContrubute and vipEnough then
						text.addEffect(children.btnOk:get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
					else
...
function UnionContribInfoView:onCreate()
	...
	uiEasy.setPrivilegeRichText(game.PRIVILEGE_TYPE.UnionContribCoinRate, self.imgBg, gLanguageCsv.unionCoin, cc.p(40, 70),false,"#C0x57472e#")
