		...
		binds = {
			...
			props = {
				...
				onItem = function(list, node, k, v)
					...
					-- 满足领取条件
					node:get("btnGet"):loadTextureNormal("common/btn/btn_cl.png")
					if v.state == 1 then
						showTxt = gLanguageCsv.commonTextGet
						node:get("btnGet"):loadTextureNormal("common/btn/btn_kfsyj.png")
						y = 180
						canGet = true
					...
					text.addEffect(node:get("btnGet.textNote"), { outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
