...
local function downHero(list, node, k, v)
	...
	text.addEffect(normalPanel:get("textIdx"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
	normalPanel:show()
...
local function upHero(list, node, k, v)
	...
	text.addEffect(node:get("flag.textMe"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
	text.addEffect(children.info:get("textLv"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
	text.addEffect(children.info:get("textLvNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
	text.addEffect(children.info:get("textFightPoint"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
	node:get("flag"):visible(v.roleId == list.roleId())
	node:get("normal.textIdx"):text(k)
	text.addEffect(node:get("normal.textIdx"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
...
local function onInitTeam(list, node, k, v)
	...
	text.addEffect(node:get("flag.textIdx"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK, size = 4}})
	text.addEffect(node:get("flag.textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK, size = 4}})
...
function UnionAssignView:playChangeAction(curPos, tarPos)
	...
	text.addEffect(curPosClone:get("flag.textMe"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK}})
	text.addEffect(curPosClone:get("info.textLv"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK, size = 3}})
	text.addEffect(curPosClone:get("info.textLvNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.BLACK, size = 3}})
