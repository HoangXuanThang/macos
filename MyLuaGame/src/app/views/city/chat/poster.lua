...
function ChatPoster:onCreate()
	...
	local rich1 = rich.createWithWidth("#C0x57472E#"..gLanguageCsv.preventFraudPosterDes1, 50, nil, 600)
	rich1:setAnchorPoint(0, 0.5)
	rich1:formatText()
	rich1:addTo(self:getResourceNode(), 10)
			:xy(self.pos1:xy())

	local rich2 = rich.createWithWidth("#C0x57472E#"..gLanguageCsv.preventFraudPosterDes2, 50, nil, 600)
	rich2:formatText()
