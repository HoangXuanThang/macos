local ActivityZhutiYingxiongPassportBuy = class("ActivityZhutiYingxiongPassportBuy", Dialog)
ActivityZhutiYingxiongPassportBuy.RESOURCE_FILENAME = "activity_zhuti_yingxiong_buy.json"
ActivityZhutiYingxiongPassportBuy.RESOURCE_BINDING = {
	["btnClose"] = {
		binds = {
			event = "touch",
...
function ActivityZhutiYingxiongPassportBuy:onCreate(activityId, cb)
	self:initModel()
	self.cb = cb
	...
	self.btnBuy:get("price"):text(string.format(gLanguageCsv.symbolMoney,price))
...
function ActivityZhutiYingxiongPassportBuy:initModel()
	self.yyhuodongs = gGameModel.role:getIdler("yyhuodongs")
end

function ActivityZhutiYingxiongPassportBuy:onBuyClick(list, v)
	local rechargeCfg = csv.yunying.playpassport_recharge
...
function ActivityZhutiYingxiongPassportBuy:onClose()
	self:addCallbackOnExit(self.cb)
	Dialog.onClose(self)
end

return ActivityZhutiYingxiongPassportBuy
