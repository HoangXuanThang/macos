...
local ActivityZhutiYingxiongShop = class("ActivityZhutiYingxiongShop", cc.load("mvc").ViewBase)

ActivityZhutiYingxiongShop.RESOURCE_FILENAME = "activity_zhuti_yingxiong_shop.json"
ActivityZhutiYingxiongShop.RESOURCE_BINDING = {
	["bg"] = "bg",
	["item"] = "item",
	["sublist"] = "sublist",
	["list"] = {
				...
				onCell = function(list, node, k, v)
					...
					if v.rmb then
						...
						if type(v.rmb) ~= "string" then
							...
							adapt.oneLineCenterPos(cc.p(180, 60), { rmbIcon, price }, cc.p(0, 0))
						end
					elseif v.price then
...
function ActivityZhutiYingxiongShop:onCreate(activityId)
	gGameModel.currday_dispatch:getIdlerOrigin("zhutiYingxiongShopClick"):set(true)
...
function ActivityZhutiYingxiongShop:initModel()
	self.yyhuodongs = gGameModel.role:getIdler("yyhuodongs")
	self.level = gGameModel.role:read("level")
end

function ActivityZhutiYingxiongShop:onBuyClick(list, k, v)
...
return ActivityZhutiYingxiongShop
