				...
				onItem = function(list, node, k, v)
					...
					for id,recharges in orderCsvPairs(rechargesCfg) do
						if id == cfg.rechargeID then
							price = recharges["rmbDisplay_"..LOCAL_LANGUAGE] or recharges.rmbDisplay
							childs.btnBuy:getChildByName("txtNode"):text(string.format(gLanguageCsv.symbolMoney, price))
							break
						end
					end
