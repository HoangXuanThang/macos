...
function ActivityGamePassportView:refreshRewardItem(item, id)
	...
	text.addEffect(childs.lv, {outline={color=ui.NEWCOLORS.OUTLINE.YELLOW, size = 3}})
	text.addEffect(childs.lv1, {outline={color=ui.NEWCOLORS.OUTLINE.YELLOW, size = 3}})
...
function ActivityGamePassportView:refreshTarget()
	...
	text.addEffect(self.target:getChildByName("lv"), {outline={color=ui.NEWCOLORS.OUTLINE.YELLOW, size = 3}})
	text.addEffect(self.target:getChildByName("lv1"), {outline={color=ui.NEWCOLORS.OUTLINE.YELLOW, size = 3}})
