    ...
    idlereasy.when(self.yyhuodongs, function (obj, yyhuodongs)
        ...
        for i=1,MAX_RECHARGE_NUMS do
            ...
            if info then
                ...
                text.addEffect(childs.btnRecharge:get("txtNode"), {outline={color= ui.NEWCOLORS.OUTLINE.YELLOW, size=4}})
                ...
                adapt.oneLineCenterPos(cc.p(213, 490), {childs.txtTitleNode, childs.rechargeNum, childs.iconDiamondTtitle},cc.p(5, 0))
                -- 充值/领取特效
