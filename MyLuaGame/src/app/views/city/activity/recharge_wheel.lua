...
ActivityRechargeWheelView.RESOURCE_BINDING = {
   ...
   -- ["recordPanel.btnOneDraw.txtNode"] = "txtOneNode",
    ...
    ["recordPanel.btnOneDraw.txtNode"] = {
		varname = "txtOneNode",
        binds = {
            event = "effect",
	...
	["recordPanel.btnAllDraw.txtNode"] = {
        binds = {
            event = "effect",
	...
	["wheelPanel.btnRules.txtSkipAni"] = {
        binds = {
            event = "effect",
            data = {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 3}},
        },
...
function ActivityRechargeWheelView:initMyInfo()
    ...
    local richText = rich.createByStr(string.format(gLanguageCsv.rechargeWheelTip, paramMap.recharge, paramMap.addScore), 40)
        :anchorPoint(0, 0.5)
        :xy(self.totalScore:x()-20, self.totalScore:y() - 50)
        :addTo(self.recordPanel)
        :z(10)
        richText:ignoreContentAdaptWithSize(false)
        richText:setContentSize(cc.size(720,200))
end
...
function ActivityRechargeWheelView:initSkel()
    ...
    self.wheelSkel:anchorPoint(cc.p(0.5,0.5))
        :xy(self.wheelPointer:x()+8, self.wheelPointer:y() - 14)
        :scale(2)
end
