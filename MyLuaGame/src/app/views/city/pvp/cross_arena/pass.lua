...
function CrossArenaPass:onCreate(role1, role2)
	...
	adapt.oneLineCenterPos(cc.p(self.textName1:x(), -52 + 700), {self.textNote1, self.textLv1}, cc.p(5,0))
	adapt.oneLineCenterPos(cc.p(self.textName2:x(), -52 + 700), {self.textNote2, self.textLv2}, cc.p(5,0))
