...
function CrossMineLineUpView:initUI()
	...
	adapt.oneLineCenterPos(cc.p(x1 + 180, 740), { self.panelSelf[3], self.panelSelf[2], self.panelSelf[1] },
		cc.p(12 + math.abs(dL) * 0.2, 0))
	adapt.oneLineCenterPos(cc.p(x2 + 180, 740), { self.panelOther[1], self.panelOther[2], self.panelOther[3] },
		cc.p(12 + math.abs(dR) * 0.2, 0))
end
