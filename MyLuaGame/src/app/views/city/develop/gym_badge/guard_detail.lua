...
function gymBadgeGuardDetailView:onCreate(parms)
	...
	local str1 = gLanguageCsv.rarityAdditionText;
	str1 = string.gsub(str1, "#C0x5b545b#", "#C0xFFFFFF#")
	str1 = string.gsub(str1, "#C0x5C9970#", "#C0x06C545#")
	local str2 = gLanguageCsv.advanceAdditionText;
	str2 = string.gsub(str2, "#C0x5b545b#", "#C0xFFFFFF#")
	str2 = string.gsub(str2, "#C0x5C9970#", "#C0x06C545#")
	local str3 = gLanguageCsv.starAdditionText;
	str3 = string.gsub(str3, "#C0x5b545b#", "#C0xFFFFFF#")
	str3 = string.gsub(str3, "#C0x5C9970#", "#C0x06C545#")


	rich.createWithWidth(string.format(str1, ui.QUALITYCOLOR[unitCsv.rarity + 2]..gLanguageCsv["rarityCard"..(unitCsv.rarity-1)], rarityNum), 40, nil, 1000)
			:addTo(self.txt1, 10)
			:anchorPoint(cc.p(0, 0.5))
			:xy(0, -5)
			:formatText()
	rich.createWithWidth(string.format(str2, ui.QUALITYCOLOR[quality]..str, advanceNum), 40, nil, 1000)
			:addTo(self.txt2, 10)
			:anchorPoint(cc.p(0, 0.5))
			:xy(0, -5)
			:formatText()
	rich.createWithWidth(string.format(str3, self.star, starNum), 40, nil, 1000)
			:addTo(self.txt3, 10)
			:anchorPoint(cc.p(0, 0.5))
			:xy(0, -5)
			:formatText()
	...
	if value then
		local str4 = gLanguageCsv.nNatureAdditionText;
		str4 = string.gsub(str4, "#C0x5b545b#", "#C0xFFFFFF#")
		str4 = string.gsub(str4, "#C0x5C9970#", "#C0x06C545#")
		rich.createWithWidth(string.format(str4, max, value), 40, nil, 1000)
			:addTo(self.txt4, 10)
			:anchorPoint(cc.p(0, 0.5))
			:xy(0, -5)
			:formatText()
	...
	if isSame == true then
		local str5 = gLanguageCsv.sameNatureAdditionText;
		str5 = string.gsub(str5, "#C0x5b545b#", "#C0xFFFFFF#")
		str5 = string.gsub(str5, "#C0x5C9970#", "#C0x06C545#")
		rich.createWithWidth(string.format(str5, sameNum), 40, nil, 1000)
			:addTo(self.txt5, 10)
			:anchorPoint(cc.p(0, 0.5))
			:xy(0, -5)
			:formatText()
