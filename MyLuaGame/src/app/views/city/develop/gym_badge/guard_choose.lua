...
function gymBadgeGuardChooseView:onCreate(parms)
	...
	self:initModel()
	self.sortPanel:xy(self.sortPanel:x() - 308, 1027)
	...
	idlereasy.any({self.notAllCardsBtn, self.allCardsBtn}, function(_, notAllCardsBtn, allCardsBtn)
		...
		text.addEffect(self.allBtn:get("txt"), {color = ui.COLORS.NORMAL.WHITE,outline = {color =  allCardsBtn and ui.NEWCOLORS.OUTLINE.YELLOW or ui.NEWCOLORS.OUTLINE.BLUE, size = 3}})
		text.addEffect(self.useBtn:get("txt"), {color = ui.COLORS.NORMAL.WHITE,outline = {color = not allCardsBtn and ui.NEWCOLORS.OUTLINE.YELLOW or ui.NEWCOLORS.OUTLINE.BLUE, size = 3}})
	end)
