...
function TrainLevelUpgrade:onCreate(oldlevel, params)
	...
	widget.addAnimation(self.pos, "config/trainer/trainer_"..self.trainerLevel:read() ..".png", "", 2)
	...
	local spine1 = widget.addAnimationByKey(pnode, "level/jiesuanshengli.skel", "spine1", "xjiesuan_jinshengzi", 103)
