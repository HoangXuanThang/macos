		...
		binds = {
			...
			props = {
				...
				onItem = function(list, node, k, v)
					...
					local path = "common/box/box_jb_00.png"
					if not isOpened then
						path = "common/box/box_jb_01.png"
					end
					...
					text.addEffect(childs.btnJump:get("textNote"), {outline = {color = ui.NEWCOLORS.OUTLINE.YELLOW, size = 4}})
...
function UpgradeNoticeView:onCreate(oldLevel)
	...
	--end
	if next(noticeDatas) == nil then
		self.bgt:visible(true)
	else
		self.bgt:visible(false)
	end
