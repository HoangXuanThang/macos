...
game.VIP_LIMIT                = 20      -- vip上限
game.VIP_SUPREME              = 19      -- 至尊VIP
game.STAMINA_LIMIT            = 9000    -- 体力上限
...
game.ATTRDEF_ENUM_TABLE = {
	...
	damageHit = 94,   -- 伤害命中
	damageDodge = 95, -- 伤害闪避
	finalDamageAdd = 96, -- 最终伤害增加
	finalDamageSub = 97, -- 最终伤害减少
}
...
game.ITEM_TICKET = {
	...
	skinCard = 536,              -- 时装点券
	chipCard = 537,              -- 秘籍抽取券
	fereHouseVideoChip = 30,     --小屋解锁视频碎片
	fereHouseClothChip = 31,     --小屋解锁衣服碎片
	lotterySkinItem = 95,        -- 皮肤抽奖 盘龙神迹
	christmasItem = 97,          -- 英雄抽奖 圣诞
	lotteryZhuTiYingXiongItem = 87, -- 主题抽奖
	lotteryJiuWeiItem = 103,     -- 九尾抽奖
	monopolyItem = 105,    -- 神州秘宝
	throneDrawItem = 107,    -- 登天之阶
	drawLimitHelditemItem = 113,    -- 宝库
	drawLimitExpItem = 115,    -- 通灵
...
-- 品质对应的第一个阶数
game.QUALITY_TO_FITST_ADVANCE = { 1, 2, 5, 9, 14, 20, 26, 31 }
...
game.CHIP_CSVID_LIMIT = 70000            -- 学习秘籍
...
game.YYHUODONG_TYPE_ENUM_TABLE = {
	...
	directBuyGift = 33,       -- # gói ưu đãi
	limitBuyGift = 34,        -- # gói giới hạn (hoạt động giới hạn)
	passport = 35,            -- # 限时通行证
	...
	guideGift = 71,           -- #弹窗礼包
	surpriseGift = 72,        -- #惊喜礼包

	weeklyCardFR = 74,        -- #新首充
	limitDayGift = 75,        -- #新登录礼包

	themeSkin = 97,           -- #主题皮肤
	limitUpgradeSprite = 98,  -- #主题神兽
	customizeUpgradeSprite = 99, -- #本命自选神兽

	christmasWish = 101,      -- 圣诞祈愿
	jiuWei = 104,             -- 九尾

	drawLimitTask = 192, -- 通灵任务
	drawLimitExplor = 193, -- 通灵契约
	drawLimitHelditem = 194, -- 超凡宝库

	throneDraw = 195,     			-- 登天之阶
	monopolyWalk = 196,     		-- 神州秘宝
	zhutiYingxiong = 199,     -- 主题英雄
}
...
game.MESSAGE_TYPE_DEFS = {
	...
	crossChat = 21,           -- 跨服聊天
	crossCardShare = 22,      -- 跨服卡牌分享
	crossShare = 23,          -- 跨服卡牌分享
}
-- 消息类型展示
...
game.MESSAGE_SHOW_TYPE = {
	...
	[game.MESSAGE_TYPE_DEFS.crossChat] = { 2, 3 },
	[game.MESSAGE_TYPE_DEFS.crossCardShare] = { 4 },
	[game.MESSAGE_TYPE_DEFS.crossShare] = { 4 },
}
...
game.SCENE_TYPE = {
	...
	crossUnionFight  = 22, -- 部屋大作战
	crossSupremacy   = 23, -- 世界锦标赛
}
...
game.TARGET_TYPE = {
	...
	DrawChipRMB = 115,           -- 钻石抽秘籍次数
	DrawChipItem = 116,          -- 道具抽秘籍次数
	DrawChip = 117,              -- 抽秘籍次数
}
...
game.SHOP_UNLOCK_KEY = {
	...
	--[17] = { unlockKey = "heldShop" },
	[18] = { unlockKey = "crossSupremacy" },
}
...
game.DIRECT_GIFT = {
	...
	THEME_SKIN_GIVE = 6,    -- 主题皮肤 赠礼

	DOUBLE11_SHOP = 7,      -- 双11商店
	THEME_SKIN_GIFT = 8,    -- 主题皮肤 礼包
	CHRISTMAS = 10,         -- 圣诞
	THEME_JIU_WEI_GIFT = 11, -- 神器 礼包

	THRONE_DRAW = 14,		-- 登天之阶

	DRAW_EXPLOR = 93, -- 通灵契约
	DRAW_HELDITEM = 94, -- 超凡宝库

	MONOPOLY_GIFT = 98, -- 秘宝礼包
	ZHUTI_YINGXIONG_SHOP = 99, -- 主题英雄商店
}
...
game.PASSPORT_IDX = {
	T_JIU_WEI = 7,       -- 九尾 战令
	T_THRONE_DRAW = 8, -- 登天之阶
	T_ZHUTI_YINGXIONG = 99, -- 主题英雄
}

game.SIGNIN_TYPE = {
	T_JIU_WEI = 8,       -- 九尾
	T_THRONE_DRAW = 9,		-- 登天之阶
	T_ZHUTI_YINGXIONG = 99, -- 主题英雄
}
...
--[[
	gGameModel.currday_dispatch:getIdlerOrigin("redHintDaily")
		:modify(function(data)
			data[game.DAILY_REDHINT.daily] = true
		end, true)

	specialTag = "redHintDaily",
	listenData = {
		sign = game.DAILY_REDHINT.daily,
	},
]]
game.DAILY_REDHINT = {
	daily = "daily",
	...
	monomolyEx = "monomolyEx",
	monomolyGift = "monomolyGift",

	throneShop = "throneShop",
	throneExchange = "throneExchange",
	limitDayGift = "limitDayGift",

	drawHeldItemGift = "drawHeldItemGift",
	drawHeldItemEx = "drawHeldItemEx",
	drawExplorGift = "drawExplorGift",
	drawExplorEx = "drawExplorEx",
}
...
game.EXCHANGE_IND = {
	...
	IDX_MONOPOLY = 98, -- 秘宝兑换
}

-- 任务
game.GENERAL_TASK_IND = {
	DRAW_EXPLOR = 93, -- 通灵契约
	DRAW_HELDITEM = 94, -- 超凡宝库
}
