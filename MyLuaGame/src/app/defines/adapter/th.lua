...
config["card_star.json"] = {
	set = {
		{ "item", "visible", false },
		{ "selectPanel.btnFrags", "visible",   false },
	},
}
...
config["drawcard.json"] = {
	set = {
		...
		{ "diamondPanel.img1", 		  "visible", false },
		{ "diamondPanel.img2",        "visible", false },
		{ "diamondPanel.img3",        "visible", false },
	},
	dockWithScreen = {
		{ "perview", "left" },
		{ "list",    "left" },
...
config["activity_limit_sprite.json"] = {
	set = {
		...
		{ "rightPanel.btnAward",  "visible", false },
	}
}
...
-- 跨服资源战预设结算界面
config["cross_tower.json"] = {
	dockWithScreen = {
		{ "towerPanel", "left",  nil, false },
		{ "waitPanel",  "left",  nil, false },
...
config["activity_midautumn_draw.json"] = {
	set = {
		{ "planeBless.tickets",          "visible", false },
	},
	dockWithScreen = {
		{ "leftPanel",  "left",  "down", true },
		{ "rightPanel", "right", "down", true },
...
config["fere_video.json"] = {
	set = {
		{ "bottom.slider", "capInsets", { cc.rect(11, 10, 1, 40) } },
	}
}

config["fere_house.json"] = {
	dockWithScreen = {
		{ "leftPanel",  "left" },
		{ "rightPanel", "right" },
	},
	set = {
		{ "rightPanel.btn_cloth", "visible", false },
		{ "rightPanel.btn_ani",   "visible", false },
	}
}

config["activity_star_upgrade.json"] = {
	set = {
		{ "panel", "visible", false },
	},
...
config["activity_guide_gift.json"] = {
	set = {
		-- {"PanelBtn", "visible", false},
		{ "PanelPrice.checkBox1.selected", "visible", true },
		{ "PanelPrice.checkBox2.selected", "visible", false },
		{ "PanelPrice.checkBox3.selected", "visible", false },
	}
}

-- 锦标赛

config["cross_supremacy.json"] = {
	dockWithScreen = {
		{ "downPanel", "right" },
	},
}

config["cross_supremacy_rank_info.json"] = {
	set = {
		{ "showList.item", "visible", false },
	}
}

config["cross_supremacy_award.json"] = {
	set = {
		{ "rewardPanel.rankItem", "visible", false },
		{ "leftPanel.tabItem",    "visible", false }
	}
...
config["cross_supremacy_info.json"] = {
	set = {
		{ "item", "visible", false },
	}
}

config["cross_supremacy_record_info.json"] = {
	set = {
		{ "item", "visible", false },
	}
}

config["cross_supremacy_history.json"] = {
	dockWithScreen = {
		{ "leftPanel", "left" },
	},
}

config["cross_supremacy_battle_array.json"] = {
	set = {
		{ "upPosition", "visible", false },
	}
}
config["activity_surprise_gift.json"] = {
	set = {
		{ "item", "visible", false }
	}
}
...
-- 圣诞
config["activity_christmas.json"] = {
	dockWithScreen = {
		{ "left",  "left",  nil, true },
		{ "right", "right", nil, true },
	}
...
config["activity_christmas_gift.json"] = {
	set = {
		{ "sublist", "visible", false },
		{ "item", "visible", false },
	},
...
config["activity_christmas_award.json"] = {
	set = {
		{ "item", "visible", false },
	},
}
