...
local channels = { 'all', 'news', 'world', 'union', 'team', 'huodong', 'private', 'marquee', 'cross' }
local MessageChannelType = {
	...
	[game.MESSAGE_TYPE_DEFS.crossChat] = { 'cross' },
	[game.MESSAGE_TYPE_DEFS.crossCardShare] = { 'cross' },
	[game.MESSAGE_TYPE_DEFS.crossShare] = { 'cross' },
}
